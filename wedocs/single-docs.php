...
get_header();
    ...
    while ( have_posts() ) : the_post();
        ?>
        <div id="breadcrumbs" style="background: #E1E6EE; border-top: 1px solid #DAE2EF; border-bottom: 1px solid #DAE2EF;">
          <div class="container p-0">
            <div class="row ddoc-single-breadcrumbs">
              ...
              <div class="clickIconLeft">
                  <span class="bar"></span>
                  <span class="bar"><i class="fas fa-sort-down" style="position: absolute; right: -14px; top: -10px;"></i></span>
                  <span class="bar"></span>
              </div>
            </div>
          </div>
