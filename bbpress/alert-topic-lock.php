	...
	<div class="bbp-alert-outer">
		<div class="bbp-alert-inner">
			...
			<p class="bbp-alert-actions">
				<a class="bbp-alert-back" href="<?php bbp_forum_permalink( bbp_get_topic_forum_id() ); ?>"><?php esc_html_e( 'Leave', 'ddoc' ); ?></a>
				<a class="bbp-alert-close" href="#"><?php esc_html_e( 'Stay', 'ddoc' ); ?></a>
			</p>
		</div>
	</div>
