...
$(document).ready(function () {
  function menu_derecha() {
    if ($('.doc-sidebar-menu doc-nav-list').hasClass('current_page_item')) {
      alert("Prueba");
  	}
...
function ddoc_doc_banner( $banner ) {  ?>
    <div class="ddoc-banner" style="min-height: 400px; padding: 150px 0px 50px; background: url(<?php the_field('imagen_fondo'); ?>)">
      <div class="container">
                 ...
                 <div class="row">
                   <div class="col-4 col-sm-2">
                     <div class="icono-categoria">
                       ...
                       <div class="info">
                           <h5 class="icono-titulo">Cinépolis Klic®</h5>
                       </div>
                       </a>
                     </div>
                    </div>
                   <div class="col-4 col-sm-2">
                     <div class="icono-categoria">
                       ...
                       <div class="info">
                           <h5 class="icono-titulo">Contenido</h5>
                       </div>
                       </a>
                     </div>
                   </div>
                   <div class="col-4 col-sm-2">
                     <div class="icono-categoria">
                       ...
                       <div class="info">
                           <h5 class="icono-titulo">Métodos de Pago</h5>
                       </div>
                       </a>
                     </div>
                   </div>
                   <div class="col-4 col-sm-2">
                     <div class="icono-categoria">
                       ...
                       <div class="info">
                           <h5 class="icono-titulo">Dispositivos</h5>
                       </div>
                       </a>
                     </div>
                   </div>
                   <div class="col-4 col-sm-2">
                     <div class="icono-categoria">
                       ...
                       <div class="info">
                           <h5 class="icono-titulo">Canales</h5>
                       </div>
                       </a>
                     </div>
                   </div>
                   <div class="col-4 col-sm-2">
                     <div class="icono-categoria">
                       ...
                       <div class="info">
                           <h5 class="icono-titulo">Promociones</h5>
                       </div>
                     </a>
                     </div>
                   </div>
